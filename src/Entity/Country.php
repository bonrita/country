 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/content/country/{country}",
 ...
 *     "collection" = "/admin/content/country",
 *   },
...
class Country extends ContentEntityBase implements CountryInterface {
  ...
  /**
   * Returns the country slug.
   *
   * @return string
   */
  public function getSlug() {
    return $this->get('field__slug')->value;
  }
  ...
  public function getCountryLanguages() {
    ...
    foreach ($this->get('field_country_languages') as $field) {
